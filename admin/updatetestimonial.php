...
$tid=$_GET['id'];
$sql="select * from testimonial where tid=$tid";
...
<div id="main">
    <div class="container">
<form action="process/processupdatetestimonial.php" method="POST">
<div class="container-fruid" align="center">
<div class="form-group col-4" align="left">
<h1 class="" style="text-align:left">Testimonial</h1>
<label for="">Testimonials ID</label>
  <input type="text" class="form-control" name="tid" id="" aria-describedby="helpId" placeholder="" readonly value="<?php echo $data[0]; ?>">
<label for="">ID</label>
  ...
  <textarea type="text" class="form-control" name="testimonial" id="" aria-describedby="helpId" placeholder="" rows="4" cols="50" value="<?php echo $data[2]; ?>"><?php echo $data[2]; ?></textarea>
  <label for="">Customers name</label>
  <input type="text" class="form-control" name="cname" id="" aria-describedby="helpId" placeholder="" value="<?php echo $data[3]; ?>">
